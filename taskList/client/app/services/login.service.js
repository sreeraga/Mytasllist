...
var LoginServices = (function () {
    ...
    LoginServices.prototype.getAuth = function (username, password) {
        console.log('inside service');
        //{ console.log('inside service'+res.json())}
        return this.http.get('http://localhost:3000/api/task/' + username + "/" + password).map(function (res) { return res.json(); });
    };
